...
public class UserController {
	...
	//getAllUser
	@GetMapping("/auth/all")
	@PreAuthorize("hasRole('ADMIN')")  // hasRole methodu 'ROLE_' kendisi ekliyor
	...
	//sisteme giren kullanici bilgilerini getiren method
	//giris yapan kullanicinin profil sayfasinda kendi bilgilerini gormesi icin
	@GetMapping
