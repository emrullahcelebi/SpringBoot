...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	// User ve Role arasında ManyToMany ilişkide default olarak LAZY tanımlıydı,
	   ...
	   //OneToMAny  vey ManyToMany ----> LAZY
	   //OneToOne veya ManyToOne ---> EAGER
		  
	   //parantez icine id yazdik , boylelikle roller gelmemias oldu
	   //user ve roller iliskili iken ben sadece user ler gelsin istiyorsam
