...
@Configuration
@EnableGlobalMethodSecurity(prePostEnabled=true)// method bazli calisacagim
public class SecurityConfig {
	...
	public PasswordEncoder passwordEncoder() {
		return new BCryptPasswordEncoder(10); //bunu kullanmamizin sebebi gomulu geliyor diye 
	}
