...
public interface UserRepository extends JpaRepository<User,Long> {
	...
	//yoksa diye null lardan kurtulmak icin Optional
	   Optional<User>  findByUserName(String userName) throws ResourceNotFoundException;//null pointer yonetmek icin
}